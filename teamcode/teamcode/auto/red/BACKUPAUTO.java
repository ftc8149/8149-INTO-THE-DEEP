...
@Autonomous(name="BACKUPAUTO", group="Testing")
...
public class BACKUPAUTO extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        strafingDrive(1, 1, 35, 0.5);
        sleep(150);
        linearDrive(-1, 1, 275, 3);
        sleep(150);
        strafingDrive(1, 1, 10, 1);
        sleep(150);
        rotationDrive(1,1,160,1);
        sleep(300);
        linearDrive(-1, 1, 425, 3);
        sleep(300);

        linearDrive(1, 1, 425, 3);
        sleep(300);
        strafingDrive(-1, 1, 7, 0.5);
        sleep(300);
        linearDrive(-1, 1, 425, 3);
        sleep(300);
