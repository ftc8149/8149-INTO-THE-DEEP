...
//of YesMk2. :D -LF
@TeleOp(name="YesMk2", group="TeleOps")


public class YESMK2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            FLPower = (yAxisInput + xAxisInput + zAxisInput) * speedFactor;
            FRPower = (yAxisInput - xAxisInput - zAxisInput) * speedFactor;
            BLPower = (yAxisInput - xAxisInput + zAxisInput) * speedFactor;
            BRPower = (yAxisInput + xAxisInput - zAxisInput) * speedFactor;
            ...
            //bootMotor.setPower((-gamepad2.left_stick_y) + gamepad2.left_stick_y);
